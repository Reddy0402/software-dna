...
from app.api.v1.endpoints import health, repositories, scan, parse, extract, dependencies, graph, graph_explorer, analytics
...
api_router.include_router(graph_explorer.router, prefix="/graph", tags=["graph-explorer"])
